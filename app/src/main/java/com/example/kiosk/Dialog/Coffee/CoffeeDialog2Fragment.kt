...
import com.example.kiosk.databinding.FragmentCoffeeDialog2Binding
import com.example.kiosk.model.CafeData

class CoffeeDialog2Fragment(context: Context) : DialogFragment() {
    ...
    private var _binding: FragmentCoffeeDialog2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding= FragmentCoffeeDialog2Binding.inflate(layoutInflater)
        ...
        binding!!.whipping1.setOnClickListener{
            selectdegreeButton(binding!!.whipping1)
            deselectdegreeButton(binding!!.whipping2)
            deselectdegreeButton(binding!!.whipping3)
            cafeData!!.whipping=1
        }
        binding!!.whipping2.setOnClickListener{
            selectdegreeButton(binding!!.whipping2)
            deselectdegreeButton(binding!!.whipping1)
            deselectdegreeButton(binding!!.whipping3)
            cafeData!!.whipping=2
        }
        binding!!.whipping3.setOnClickListener{
            selectdegreeButton(binding!!.whipping3)
            deselectdegreeButton(binding!!.whipping1)
            deselectdegreeButton(binding!!.whipping2)
            cafeData!!.whipping=3
        }
    ...
    private fun selectdegreeButton(button: Button) {
        ...
        if (button.id == binding!!.hotButton.id) {
